...
public class GameNuonVunly extends GameActivity {
    ...
    {
        tvStoryText.setText("wow...one single grenade...\n1. end yourself \n2. throw to the monster");
    ...
    private void left()
    {
        tvStoryText.setText("You took left and then see a split way again, Which way you going? ");
        setAllBtnsVisible();
        btn1.setText("Left");
        btn2.setText("Right");
        btn3.setVisibility(View.INVISIBLE);
    ...
    private void door()
    {
        tvStoryText.setText("This giving you time to rush to the door. beside you there: \n1. A key \n2. An axe");
        setAllBtnsVisible();
        btn1.setText("A key");
        btn2.setText("An axe");
        btn3.setVisibility(View.INVISIBLE);
